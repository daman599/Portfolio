...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 w-full left-0 backdrop-blur-md bg-[#0a0a0a]/50 z-50">
      <div className="flex justify-between py-1 px-2 sm:px-6 md:px-10 lg:px-28 xl:px-[194px]">

        <div className="px-2 py-2 md:py-3 text-base md:text-2xl font-normal tracking-[3px] hover:text-[#999999] cursor-default">
          daman
        </div>

        <div className="flex gap-1 sm:gap-3 p-1 md:p-2">
