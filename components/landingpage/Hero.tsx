  ...
  return (
    <>
      <div className="relative w-full h-screen flex flex-col items-center justify-center mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="mt-12 text-[40px] md:text-[52px] lg:text-6xl flex flex-col items-center leading-[1.1] text-center">
        ...
        <div className="mt-6 md:mt-10 font-medium text-[#999999] leading-relaxed text-center">
          ...
          <div className="text-sm sm:text-lg md:text-xl lg:text-2xl mt-2 lg:mt-3">
