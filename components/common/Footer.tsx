...
const Footer = () => {
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between w-full mt-8 max-w-6xl px-4 sm:px-6 md:px-10 lg:px-24 xl:px-1 mx-auto gap-9 md:gap-12 lg:gap-20">
      ...
      <div className="w-full xl:max-w-[1145px] h-px bg-[#1C1C1C] mt-8 mx-auto" />
